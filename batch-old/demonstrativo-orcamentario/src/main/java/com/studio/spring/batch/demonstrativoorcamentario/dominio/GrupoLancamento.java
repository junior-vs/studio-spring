...
public class GrupoLancamento {
    ...
    public String toString() {
        return String.format(
                "GrupoLancamento [codigoNaturezaDespesa=%s, descricaoNaturezaDespesa=%s, lancamentos=%s, lancamentoTmp=%s]",
                codigoNaturezaDespesa, descricaoNaturezaDespesa, lancamentos, lancamentoTmp);
    }
